...
package net.mcreator.endnemeralds.particle;
...
public class PoopportalparticalParticle extends EndNEmeraldsModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public PoopportalparticalParticle(EndNEmeraldsModElements instance) {
		super(instance, 28);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("poopportalpartical"));
	}
