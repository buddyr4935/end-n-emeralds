...
public class PinkgrassBlock extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:pinkgrass")
	public static final Block block = null;
	public PinkgrassBlock(EndNEmeraldsModElements instance) {
		super(instance, 1);
	}
