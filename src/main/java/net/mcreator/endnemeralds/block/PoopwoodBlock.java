...
public class PoopwoodBlock extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:poopwood")
	public static final Block block = null;
	public PoopwoodBlock(EndNEmeraldsModElements instance) {
		super(instance, 25);
	}
