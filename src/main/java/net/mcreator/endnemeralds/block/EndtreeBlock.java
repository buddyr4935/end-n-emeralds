...
import net.mcreator.endnemeralds.procedures.EndtreePlantRightClickedProcedure;
...
public class EndtreeBlock extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:pinkflower")
	public static final Block block = null;
	public EndtreeBlock(EndNEmeraldsModElements instance) {
		super(instance, 12);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pinkflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("end_n_emeralds:pinkflower"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				EndtreePlantRightClickedProcedure.executeProcedure($_dependencies);
			}
