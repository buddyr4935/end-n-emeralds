...
import net.mcreator.endnemeralds.procedures.AcidMobplayerCollidesBlockProcedure;
...
public class AcidBlock extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("end_n_emeralds:acid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public AcidBlock(EndNEmeraldsModElements instance) {
		super(instance, 34);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("end_n_emeralds:blocks/acidflowingandstill"),
						new ResourceLocation("end_n_emeralds:blocks/acidflowingandstill")).luminosity(0).density(1000).viscosity(1000))
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("end_n_emeralds:acid_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
