...
public class Emerald_ToolsHoeItem extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:emerald_tools_hoe")
	public static final Item block = null;
	public Emerald_ToolsHoeItem(EndNEmeraldsModElements instance) {
		super(instance, 40);
	}
