...
public class AmethystArmorItem extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:amethyst_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("end_n_emeralds:amethyst_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("end_n_emeralds:amethyst_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("end_n_emeralds:amethyst_armor_boots")
	public static final Item boots = null;
	public AmethystArmorItem(EndNEmeraldsModElements instance) {
		super(instance, 88);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "end_n_emeralds:textures/models/armor/amethyst_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
