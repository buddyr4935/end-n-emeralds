...
public class Emerald_ToolsPickaxeItem extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:emerald_tools_pickaxe")
	public static final Item block = null;
	public Emerald_ToolsPickaxeItem(EndNEmeraldsModElements instance) {
		super(instance, 36);
	}
