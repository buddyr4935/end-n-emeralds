...
package net.mcreator.endnemeralds.world.dimension;
...
import net.mcreator.endnemeralds.particle.PoopportalparticalParticle;
import net.mcreator.endnemeralds.item.PoopdimensionItem;
...
public class PoopdimensionDimension extends EndNEmeraldsModElements.ModElement {
	@ObjectHolder("end_n_emeralds:poopdimension_portal")
	public static final CustomPortalBlock portal = null;
	public PoopdimensionDimension(EndNEmeraldsModElements instance) {
		super(instance, 22);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(PoopblockBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("end_n_emeralds:poopdimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.addParticle(PoopportalparticalParticle.particle, px, py, pz, vx, vy, vz);
			}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("end_n_emeralds:poopdimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("end_n_emeralds:poopdimension")));
				} else {
					entity.func_242279_ag();
