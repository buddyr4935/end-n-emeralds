...
import net.mcreator.endnemeralds.block.PinkstoneBlock;
...
public class EviebiomeBiome extends EndNEmeraldsModElements.ModElement {
	public static Biome biome;
	public EviebiomeBiome(EndNEmeraldsModElements instance) {
		super(instance, 1);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13057).setWaterColor(-26113).setWaterFogColor(329011)
						.withSkyColor(-13057).withFoliageColor(-13057).withGrassColor(-3407668)
						.setMusic(new BackgroundMusicSelector(
								...
								24000, true))
						.setParticle(new ParticleEffectAmbience(ParticleTypes.PORTAL, 0.01f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(PinkgrassBlock.block.getDefaultState(),
								PinkstoneBlock.block.getDefaultState(), PinkstoneBlock.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.PURPUR_PILLAR.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.FIREWORK_ROCKET, 20, 10, 10));
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.CAT, 20, 15, 20));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("end_n_emeralds:eviebiome"));
			}
		}
	}
	@Override
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("eviebiome_ctd");
